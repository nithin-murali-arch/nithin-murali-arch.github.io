// Early Retirement What If Calculator Class
class EarlyRetirementWhatIfCalculator extends CalculatorBase {
    constructor(config) {
        super(config);
        this.setupEventListeners();
    }

    // Override validation for early-retirement-what-if calculator
    validateTab(tabId) {
        switch (tabId) {
            case 'basic':
    ...
    // Override calculate method for early-retirement-what-if-specific calculations
    calculate() {
    ...
    // Override populateForm to handle early-retirement-what-if-specific data
    populateForm() {
        super.populateForm();
...
window.EarlyRetirementWhatIfCalculator = EarlyRetirementWhatIfCalculator;